...
| --ota-upload-max-in-flight   | integer      | 5                | No       | Maximum number of OTA firmware uploads that may be reserved or transferring at once — env `OTA_UPLOAD_MAX_IN_FLIGHT`                                                                                                                                                |
| --ota-upload-max-size-mb     | integer      | 64               | No       | Maximum size in MB of an uploaded OTA firmware image — env `OTA_UPLOAD_MAX_SIZE_MB`                                                                                                                                                                                  |
